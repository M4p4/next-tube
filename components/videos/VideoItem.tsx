...
const VideoItem: FC<Props> = ({ video, showHd = false, showViews = false }) => {
  return (
    <Link href={`/video/${video.id}`}>
      <a>
        <div className="bg-slate-300 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-gray-600 hover:text-gray-500 dark:hover:text-gray-100 dark:text-gray-300 justify-items-center rounded-md overflow-hidden hover:scale-[1.1] duration-300 relative">
          <img
