          ...
          <div className="justify-center items-start md:items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 mx-2 md:mx-0">
            ...
            >
              <div className="absolute right-2 top-3" onClick={onClose}>
                <XIcon className="w-5 h-5 hover:dark:text-gray-300 hover:text-gray-700 cursor-pointer" />
              </div>
              <div className="p-4 text-xl md:text-2xl font-semibold border-b dark:border-b-slate-700 border-b-gray-300 my-1 py-1">
                {title}
              </div>
